<template>
	<view>
        ...
        <!-- <view class="cu-item">
					...
					<view class="action">
						<MagicDatePicker placeholder="请选择" :maxDate="defaultMaxDate"></MagicDatePicker>
					</view>
    ...
    <view
      ...
      style="position: fixed;bottom:0upx;display: flex;justify-content: space-around;z-index: 2;z-index: 999;width: 100%;"
    >
...
export default {
  ...
  methods: {
	...
	CalcDateTime(){
		...
		this.itemData.Hours=parseFloat((new Date(this.itemData.EndDate.toString().replace(/-/g,'/')).valueOf()-new Date(this.itemData.BeginDate.toString().replace(/-/g,'/')).valueOf())/3600000).toFixed(1);
