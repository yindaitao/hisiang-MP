<template>
	<view>
		...
		<view class="cu-bar bg-white solid-bottom margin-top" style="background: rgba(0,0,0,0);">
			<view class="action">
				<text class="icon-title text-orange text-xxl"></text> 我的列表
			</view>
			<view class="action">
				<button class="cu-btn round line-green" @click="logout" data-target="menuModal">退出登录</button>
			</view>
		</view>
		<view class="cu-list menu" :class="[menuBorder?'sm-border':'',menuCard?'card-menu margin-top':'']" style="background: rgba(0,0,0,0);">
			<view class="cu-item" :class="menuArrow?'arrow':''" style="background: rgba(0,0,0,0);">
				<view class="content">
