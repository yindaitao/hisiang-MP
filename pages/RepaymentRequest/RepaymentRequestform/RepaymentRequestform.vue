			...
			<form>
				...
				<block v-for="(item,index) in formList" :key="index">
					...
					<view class="cu-form-group">
						...
						<input :disabled="edit?true:false" placeholder="请输入还款金额" name="input" type="digit" style="text-align: right;"
					...
					<view class="cu-form-group" readonly>
						<textarea :disabled="true" :class="item.BorrowReason?'value':''" maxlength="-1" placeholder-class="placeholder"
						 :value="item.BorrowReason"></textarea>
					</view>
					<!-- 图片开始 -->
					<view class="cu-bar bg-white">
				...
				<uni-view class="cu-bar bg-gray solid-bottom" style="width: 100%;" v-if="edit === false">
					<button class="cu-btn round bg-blue shadow sm" style="margin: 0 auto;" @tap="addOption">
						<text class="icon-add"></text><text class="margin-left-sm">增加&nbsp;&nbsp;还款明细</text>
					</button>
				</uni-view>
				<view class="cu-form-group">
