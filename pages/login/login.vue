	...
	<view class="s-page-wrapper is-100vh">
		<view class="is-33vh">
			<view class="is-flex is-column is-justify-center is-align-center is-height-100">
				<image :src="loginImg" mode="aspectFit" class="logoimg" style="top: 100px;" />
			</view>
		</view>
		<view class="content">
			<view class="has-mglr-10">
				<view class=" has-mgtb-10">
					<input type="text" v-model="logininfo.userCode" placeholder="请输入账号" class="is-input1" data-val="userCode" />
				</view>
				<view class=" has-radius has-mgtb-10">
					<input v-model="logininfo.password" placeholder="请输入登录密码" password class="is-input1" data-val="password" @confirm="handleLogin" />
				</view>
...
<script>
	import hex_md5 from "../../common/md5encrypt.js";
	import {
		mapState,
		mapMutations
	} from "vuex";
