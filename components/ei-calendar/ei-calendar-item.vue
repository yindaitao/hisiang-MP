<template>
	<view class="ei-calendar-item" :class="[
	 ...
	 @click="onDayClick">
		...
		<view class="ei-calendar-item__bottom">
			...
			<view v-if="!day.isToday" class="ei-calendar-item__bottom__today">
				<text v-for="(item, index) in bottomList" :class="[item.class || 'ei-calendar-item__bottom__item']" :key="index">{{item.text}}</text>
			</view>
		</view>
	</view>
</template>
